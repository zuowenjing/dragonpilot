...
SoftwarePanel::SoftwarePanel(QWidget* parent) : ListWidget(parent) {
  ...
  connect(onOffRoadBtn, &ButtonControl::clicked, [&]() {
    if (ConfirmationDialog::confirm(tr("Are you sure you want to switch mode?"), tr("CONFIRM"), this)) {
      bool val = params.getBool("dp_general_go_off_road");
      params.putBool("dp_general_go_off_road", !val);
    }
  });
...
void SoftwarePanel::updateLabels() {
  ...
  fs_watch->addParam("dp_general_go_off_road");
  ...
  if (params.getBool("dp_general_go_off_road")) {
